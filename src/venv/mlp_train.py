...
class MLP(object):
    ...
    def forward_propatte(self, inputs):
    ...
    def train(self, inputs, targets, epochs, learning_rate):
        ...
        for i in range(epochs):
            ...
            for j, input in enumerate(inputs):
                ...
                output = self.forward_propatte(input)
                error = target - output
    ...
    def _mse(self, target, output):
        """ Mean Squared Error loss function
            Args:
                target (ndarray) : The groud target
...
if __name__ == "__main__":
    # create a dateset to train a network for the sum operation
    ...
    # get a prediction
    output = mlp.forward_propatte(input)
